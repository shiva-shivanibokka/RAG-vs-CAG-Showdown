...
from src.config import API_ROOT_PATH, CORS_ORIGINS, GROQ_MODEL, RAG_TOP_K
...
async def lifespan(app: FastAPI):
    global _cag, _rag
    logger.info("Loading engines on startup (model=%s)...", GROQ_MODEL)
    _cag = CAGEngine(KNOWLEDGE_BASE, model=GROQ_MODEL)
    _rag = RAGEngine(KNOWLEDGE_BASE, model=GROQ_MODEL, top_k=RAG_TOP_K)
