...
from src.config import API_ROOT_PATH, CORS_ORIGINS, GEMINI_MODEL, RAG_TOP_K
...
async def lifespan(app: FastAPI):
    global _cag, _rag
    logger.info("Loading engines on startup (model=%s)...", GEMINI_MODEL)
    _cag = CAGEngine(KNOWLEDGE_BASE, model=GEMINI_MODEL)
    _rag = RAGEngine(KNOWLEDGE_BASE, model=GEMINI_MODEL, top_k=RAG_TOP_K)
